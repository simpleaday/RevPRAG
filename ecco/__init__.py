...
def from_pretrained(hf_model_id: str,
    ...
    tokenizer = AutoTokenizer.from_pretrained(hf_model_id, use_auth_token=token)
    ...
    model = model_cls.from_pretrained(hf_model_id, output_hidden_states=hidden_states, output_attentions=attention, device_map=device_map, use_auth_token=token)
