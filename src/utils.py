...
def load_models(model_code):
    ...
    if 'contriever' in model_code:
        # print('=========')
        model = Contriever.from_pretrained(model_code_to_qmodel_name[model_code], timeout=60)
        # print('=========')
        assert model_code_to_cmodel_name[model_code] == model_code_to_qmodel_name[model_code]
        c_model = model
        tokenizer = AutoTokenizer.from_pretrained(model_code_to_qmodel_name[model_code], timeout=60)
        # print('=========')
